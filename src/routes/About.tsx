      ...
      <Wrapper>
          <Container>
            ...
            <Main className={main}>
              ...
              <h1>페이지 내용</h1>
              <div>This is a fan made website and the content found on this website is owned by Cover corp and its partners. The site follows the guidelines set forth by Cover corp in their <a>Derivative Work License Agreement</a></div>
              <br/>
              <div>QnA FaQ</div>
            </Main>
          </Container>
